...
export default function Cross(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 212.982 212.982" style={{enableBackground: 'new 0 0 212.982 212.982'}} xmlSpace="preserve" width="512px" height="512px" {...props}>
      <g id="Close">
